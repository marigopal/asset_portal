                    ...
                    <div class="invoice p-3 mb-3">
                        ...
                        <div class="row invoice-info">
                            <div class="col-sm-8 invoice-col">
                                <address>
                                    <strong>Employee ID: </strong> <?php echo ${strtoupper(decrypt($_GET['eid'])) . 'emp_id'}; ?><br>
                                    <strong>Name: </strong> <?php echo ${strtoupper(decrypt($_GET['eid'])) . 'firstname'}; ?><br>
                                    <strong>Username: </strong> <?php echo ${strtoupper(decrypt($_GET['eid'])) . 'username'}; ?><br>
                                    <strong>Mobile No: </strong> <?php echo ${strtoupper(decrypt($_GET['eid'])) . 'mobile_no'}; ?><br>
                                    <strong>Email: </strong> <?php echo ${strtoupper(decrypt($_GET['eid'])) . 'email_address'}; ?><br>
                                </address>
                            </div>
