    ...
    while ($row = $result->fetch_array(MYSQLI_BOTH)) {
        ...
        <tr>
            ...
            <td>
                ...
                if ($row['models_image'] != '') {
                    ?>
                    <a href="../image_location/<?php echo $row['models_image']; ?>" target="_blank">
                        <img src="../image_location/<?php echo $row['models_image']; ?>" alt="" width="30" height="20" id="receipt_display">
                    </a>
                <?php } ?>
            </td>
